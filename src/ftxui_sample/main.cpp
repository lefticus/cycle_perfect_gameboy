...
// configuration step. It creates a namespace called `cycle_perfect_gameboy`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cycle_perfect_gameboy::cmake::project_name, cycle_perfect_gameboy::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cycle_perfect_gameboy::cmake::project_version);
      return EXIT_SUCCESS;
    }
